...
import (
	...
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/artifact"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/completion"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/farm"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/generate"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/healthcheck"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/images"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/kube"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/machine"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/machine/os"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/manifest"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/networks"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/pods"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/quadlet"
	"github.com/dmikushin/podman-shared/v5/cmd/podman/registry"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/secrets"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/system"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/system/connection"
	"github.com/dmikushin/podman-shared/v5/cmd/podman/validate"
	_ "github.com/dmikushin/podman-shared/v5/cmd/podman/volumes"
	"github.com/dmikushin/podman-shared/v5/pkg/domain/entities"
	"github.com/dmikushin/podman-shared/v5/pkg/logiface"
	"github.com/dmikushin/podman-shared/v5/pkg/rootless"
	"github.com/dmikushin/podman-shared/v5/pkg/terminal"
